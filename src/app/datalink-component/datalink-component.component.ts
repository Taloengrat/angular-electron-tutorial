...
@Component({
  selector: 'app-datalink-component',
  templateUrl: './datalink-component.component.html',
  styleUrls: ['./datalink-component.component.sass']
})
export class DatalinkComponentComponent implements OnInit {
